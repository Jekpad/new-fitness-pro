...
describe('<Profile/>', () => {
  it('should not redirect', () => {
    ...
    render(
      <MemoryRouter>
        <userContext.Provider value={{ user: mockUser, setUser: vi.fn() }}><Profile/></userContext.Provider>
      </MemoryRouter>
    );
  ...
  it('should redirect', () => {
    ...
    render(
      <MemoryRouter>
        <userContext.Provider value={{ user: null, setUser: vi.fn() }}><Profile/></userContext.Provider>
      </MemoryRouter>
    );
