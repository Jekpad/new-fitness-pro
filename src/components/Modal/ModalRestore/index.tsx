...
const ModalRestore = ({ email }: Pops) => {
  return (
    <div className=" fixed left-0 top-0 bottom-0 right-0 z-51 flex h-[100%] min-h-[100vh] w-[100%] min-w-[375px] flex-col items-center justify-center bg-black bg-opacity-20">
